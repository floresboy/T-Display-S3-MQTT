...
void display_big(const String& text, int fg , int bg ) {
    digitalWrite(PIN_LCD_BL, HIGH); // Turn BL on
...
void display_logo() {
    ...
    // 170 x 320
    sprite.pushImage (0, 0, 320, 170, COMP_LOGO);
    sprite.pushSprite(0, 0);
}
...
void display_topic(const String& mqtt_topic, const String& payload)
{
    ...
    display.setTextColor(TFT_GREEN,TFT_BLACK);    display.setTextFont(4);

...
const int       pin_portalbutton = PIN_BUTTON_1;
const int       pin_demobutton   = PIN_BUTTON_2;
const int       pin_backlight    = PIN_LCD_BL;
...
void setup() {
    ...
    WiFiSettings.onFailure = [] {
        ...
        delay(2000);
        Serial.print("Wifi connection failed, starting portal");
        WiFiSettings.portal();
    };
